...
export const autoCreateRefRule = createRule({
    ...
    meta: {
        type: "suggestion",
        docs: {
            description: "auto create a useRef hook for a ref prop within your function component",
    ...
    create(context) {
        ...
        return {
            "JSXAttribute": (node) => {
                ...
                pushImport(analyzeTypeAndCreateImports(aliasTypeArgument, tsService, tsChecker, sourceFile!, tsService.program, scopeManager, currentFilePath, tsConfigPath, {resolveToRelativePath: true}).results)
